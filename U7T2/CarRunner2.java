...
public class CarRunner2
{
    ...
    //     System.out.println("   Actual: " + actInv);
        ...
        Car car1 = new Car("Lamborghini", 5);
        Car car2 = new Car("Tesla", 40);
        Car car3 = new Car("Toyota", 50);
        Car[] cars = {car1, car2, car3};
        ArrayList<Car>arraylistCars = new ArrayList<Car>(Arrays.asList(cars));
        System.out.println(arraylistCars);
